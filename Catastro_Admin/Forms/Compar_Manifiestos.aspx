        ...
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>Ficha llenada por notaria</h5>
                        </div>
                                    ...
                                    <div id="bloque_1" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-tittle">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" class="collapsed" onclick="collapse('collapseOne_')">Ubicación del predio</a>
                                            </h5>
                                        </div>
                ...
                <div class="col-lg-6">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>Ficha con la informacion actual</h5>
                        </div>
                        <div class="ibox-content" style="display: block">
                            <div class="panel-body">
                                <div class="panel-group" id="accordion2">
                                    ...
                                    <div id="Div1" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-tittle">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseOne_" aria-expanded="false" class="collapsed">Ubicación del predio</a>
                                            </h5>
                                        </div>
                                        <div id="collapseOne_" class="panel-collapse collapse in" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-3">
                                    ...
                                    <%-- 11. Ubicacion del predio (rural) --%>
                                    <div id="Div11" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseTen_" aria-expanded="false" class="collapsed">Ubicacion del predio (rural)</a>
                                            </h5>
                                        </div>
                                        <div id="collapseTen_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-3">
                                    ...
                                    <div id="Div2" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo_" aria-expanded="false" class="collapsed">Informacion predio</a>
                                            </h5>
                                        </div>
                                        <div id="collapseTwo_" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-3">
                                    ...
                                    <div id="Div3" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseFour_" aria-expanded="false" class="collapsed">
                                                    <asp:Label ID="Label54" runat="server" Text="Datos de quien transmite"></asp:Label></a>
                                            </h5>
                                        </div>
                                        <div id="collapseFour_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-12">
                                                        <br />
                                    ...
                                    <div id="Div4" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseFive_" aria-expanded="false" class="collapsed">
                                                    <asp:Label ID="Label55" runat="server" Text="Datos de quien adquiere"></asp:Label>
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseFive_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-12">
                                                        <br />
                                    ...
                                    <div id="Div5" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse2" data-parent="#accordion" href="#collapseSix_" aria-expanded="false" class="collapsed">Domicilio de notificacion</a>
                                            </h5>
                                        </div>
                                        <div id="collapseSix_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <asp:Label ID="Label61" runat="server" Text="Codigo postal:"></asp:Label>
                                    ...
                                    <%-- 12. Uso suelo --%>
                                    <div id="Div12" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse2" data-parent="accordion" href="#collapseEleven_" aria-expanded="false" class="collapsed">Uso suelo</a>
                                            </h5>
                                        </div>
                                        <div id="collapseEleven_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <%--                                                    <div class="col-lg-4">
                                                        <asp:Label ID="Label42" runat="server" Text="Uso:"></asp:Label>
                                    ...
                                    <div id="Div6" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseThree_" aria-expanded="false" class="collapsed">Colindancias</a>
                                            </h5>
                                        </div>
                                        <div id="collapseThree_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-12">
                                    ...
                                    <%-- Label tipo subdivisio/fusion --%>
                                    <div id="tipo_sub_fus_" class="row">
                                        <div class="col-lg-12" style="text-align: center">
                                            <asp:Label ID="Label65" runat="server" Text="Subdividir" Font-Size="Large" Font-Bold="True" Visible="false"></asp:Label>
                                        </div>
                                    </div>

                                    <%-- 8. Tipo de operacion --%>
                                    <div id="Div8" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseSeven_" aria-expanded="false" class="collapsed">Tipo de operacion</a>
                                            </h5>
                                        </div>
                                        <div id="collapseSeven_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                    ...
                                    <%-- 13. Datos predios --%>
                                    <div id="Div13" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="accordion2" href="#collapseTwelve_" aria-expanded="false" class="collapsed">Datos Predios</a>
                                            </h5>
                                        </div>
                                        <div id="collapseTwelve_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                    ...
                                    <%-- 9. Documento --%>
                                    <div id="Div9" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseEight_" aria-expanded="false" class="collapsed">Documento</a>
                                            </h5>
                                        </div>
                                        <div id="collapseEight_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-3">
                                    ...
                                    <%-- 10. Impuesto sobre traslacion de dominio --%>
                                    <div id="Div10" runat="server" class="panel panel-default">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#collapseNine_" aria-expanded="false" class="collapsed">Impuesto sobre traslacion de dominio</a>
                                            </h5>
                                        </div>
                                        <div id="collapseNine_" class="panel-collapse collapse" aria-expanded="false">
                                            <div class="panel-body" style="background: #f7f7f7">
                                                <div class="row" style="text-align: center">
                                                    <div class="col-lg-4">
