...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel runat="server" ID="UP_Pagina" UpdateMode="Always">
        <ContentTemplate>
            ...
            <asp:EntityDataSource ID="Registro_Usuarios_EntityDataSource" runat="server" Where="it.id_General_Usuario = @id_registro" ConnectionString="name=Tesla_ModelContainer" DefaultContainerName="Tesla_ModelContainer" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="tb_Generales_Usuarios" EntityTypeFilter="tb_Generales_Usuarios">
                <WhereParameters>
            ...
            <asp:EntityDataSource ID="Usuarios_EntityDataSource" runat="server" OrderBy="it.nombre" Where="it.nombre Like '%' + @nombre_buscar + '%'" ConnectionString="name=Tesla_ModelContainer" DefaultContainerName="Tesla_ModelContainer" EnableFlattening="False" EntitySetName="tb_Generales_Usuarios" EntityTypeFilter="tb_Generales_Usuarios">
                <WhereParameters>
