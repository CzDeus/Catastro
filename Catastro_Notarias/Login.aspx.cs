...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void btnAcceso_Click(object sender, EventArgs e)
    {
        ...
        string strStoreProcedure = "spr_Valida_Acceso_Sistema_Notaria";
        ...
        try
        {
            ...
            if(dt.Rows.Count != 0)
            {
                Session["sist_Id_Usuario"] = dt.Rows[0]["id_Generales_Usuarios_Notarias"];
                Session["sist_Id_Notaria"] = dt.Rows[0]["id_notaria"];
